...
dir_root=$dir_shell
url_shell=${JD_SHELL_URL:-https://ghproxy.com/https://github.com/wwd460/shell.git}
url_scripts=${JD_SCRIPTS_URL:-https://ghproxy.com/https://github.com/wwd460/qxxl.git}
